 ...
 * M4 工具与 MCP Mock 适配器。
 *
 * 暴露：listTools() / listMcpServers()
 * 字段严格对齐 demo types/tool.ts 的 ToolDef / McpServer（schema / 幂等键 / 超时 / 重试）。
 *
 * 设计依据：01-api-spec.md §4。
 */
...
/** MCP 服务器状态 */
const MCP_SERVERS = [
  { server_id: 'mcp-edr', name: 'EDR-MCP', transport: 'sse', status: 'online', tools_count: 3, last_heartbeat: '2026-07-06T17:00:40.000Z' },
  { server_id: 'mcp-net', name: 'NetVis-MCP', transport: 'sse', status: 'online', tools_count: 1, last_heartbeat: '2026-07-06T17:00:38.000Z' },
  { server_id: 'mcp-ti', name: 'ThreatIntel-MCP', transport: 'stdio', status: 'online', tools_count: 1, last_heartbeat: '2026-07-06T17:00:35.000Z' },
  { server_id: 'mcp-fw', name: 'Firewall-MCP', transport: 'sse', status: 'degraded', tools_count: 1, last_heartbeat: '2026-07-06T16:58:12.000Z' },
  { server_id: 'mcp-sandbox', name: 'Sandbox-MCP', transport: 'stdio', status: 'offline', tools_count: 1, last_heartbeat: '2026-07-06T16:40:00.000Z' },
  { server_id: 'mcp-db', name: 'DB-MCP', transport: 'sse', status: 'online', tools_count: 1, last_heartbeat: '2026-07-06T17:00:30.000Z' },
]
