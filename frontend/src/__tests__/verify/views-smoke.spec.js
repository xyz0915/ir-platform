...
const VIEWS = [
  ...
  { name: 'M3 PipelineCanvasView', loader: () => import('@/views/agent-orchestration/PipelineCanvasView.vue'), expect: '流水线 DAG 画布' },
  { name: 'M4 ToolMcpView', loader: () => import('@/views/agent-orchestration/ToolMcpView.vue'), expect: '工具与 MCP' },
  { name: 'M5 MemoryRagView', loader: () => import('@/views/agent-orchestration/MemoryRagView.vue'), expect: '记忆与 RAG' },
